...
class DetaQuery:
    ...
    def __or__(self, other: Union['DetaQuery', 'DetaQueryList']) -> 'DetaQueryList':
...
class DetaQueryStatement:
    ...
    def __and__(self, other: Union['DetaQuery', 'DetaQueryList', 'DetaQueryStatement']) -> Self:
    ...
    def __or__(self, other: Union['DetaQuery', 'DetaQueryList', 'DetaQueryStatement']) -> 'DetaQueryList':
        if isinstance(other, DetaQueryList):
